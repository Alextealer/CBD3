    ...
    <section className="py-20">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-sm max-w-none space-y-6 text-muted-foreground">
          ...
          <p>Unsigned s&apos;engage a rendre sa plateforme accessible au plus grand nombre, conformement au Referentiel General d&apos;Amelioration de l&apos;Accessibilite (RGAA). Nous travaillons continuellement a ameliorer l&apos;experience utilisateur pour tous.</p>
          ...
          <p>Si vous rencontrez des difficultes d&apos;accessibilite sur notre site, n&apos;hesitez pas a nous contacter a l&apos;adresse accessibilite@unsigned.fr. Nous ferons notre maximum pour vous apporter une solution dans les meilleurs delais.</p>
        </div>
      </div>
    </section>
  );
